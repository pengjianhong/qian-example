...
const ListView$1 = lazy(() => import("./ListView-CsqdnKp3.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-CsqdnKp3.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-BhIIILgq.mjs.map
