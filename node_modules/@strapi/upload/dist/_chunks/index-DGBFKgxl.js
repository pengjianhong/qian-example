...
const dependencies = {
  ...
  "@strapi/provider-upload-local": "5.8.0",
  "@strapi/utils": "5.8.0",
  "byte-size": "8.1.1",
  cropperjs: "1.6.1",
  "date-fns": "2.30.0",
...
const admin = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./App-CppSIIEZ.js")).then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await Promise.resolve().then(() => require("./SettingsPage-DdN_brUU.js"));
...
//# sourceMappingURL=index-DGBFKgxl.js.map
