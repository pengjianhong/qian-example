...
const admin = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-CLiPAP1k.mjs").then((mod) => ({ default: mod.Upload })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-DvttEqTz.mjs");
...
//# sourceMappingURL=index-CHxEceRJ.mjs.map
