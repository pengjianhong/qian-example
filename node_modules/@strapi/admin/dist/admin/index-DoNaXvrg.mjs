  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import('./ListPage-mHBjjWxk.mjs');
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import('./SingleSignOnPage-B9mLzjRi.mjs');
        return {
...
const AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import('./Login-BCv1wfvK.mjs')).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import('./constants-DU7oNawe.mjs')).FORMS,
    {
...
const ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-CLwCdNQh.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import('./CreatePage-CfCPPYGr.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-DxEBBqUH.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-jlU2BRvA.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-CtSQnW_9.mjs');
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import('./CreatePage-C-0H2K5g.mjs');
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import('./EditPage-oamip13J.mjs').then(n => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import('./ListPage-B4XxPT7g.mjs');
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import('./ListView-BeQRnj-r.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import('./CreateView-w-hcufyx.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import('./EditViewPage-DwfsUz5e.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import('./CreateView-Bi-6vB0h.mjs');
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import('./ListView-BDpX6eAQ.mjs');
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import('./EditView-Bgq7xkna.mjs');
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import('./InstalledPlugins-1a_nfRNU.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import('./PurchaseAuditLogs-C9ATpq0U.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import('./PurchaseSingleSignOn-ouZ_j9iQ.mjs');
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import('./PurchaseContentHistory-CSlvXfkJ.mjs');
      return {
...
const getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import('./UseCasePage-eBhY0DSo.mjs');
      return {
...
const getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import('./HomePage-BWGS-AVh.mjs');
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import('./ProfilePage-YEeSFVCM.mjs');
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import('./MarketplacePage-Bu43TEkO.mjs');
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import('./Layout-BkiVSoVM.mjs');
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import('./ApplicationInfoPage-BNFbKMod.mjs');
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import('./AuthenticatedLayout-BQ6zs92s.mjs');
              return {
...
//# sourceMappingURL=index-DoNaXvrg.mjs.map
